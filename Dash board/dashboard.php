...
<!-- wsh la eetzer -->
	...
	<section class="features ">
                <figure>
					...
					<a href="\site\G4nalysis\Démarrer un ou plusieurs tests\DebutTestTemp.html" class="click_box" href="#">
                ...
                <figure>
					...
					<a href="\site\G4nalysis\Démarrer un ou plusieurs tests\DebutTestAudition.html" class="click_box" href="#">
				...
				<figure>
					...
					<a href="\site\G4nalysis\Démarrer un ou plusieurs tests\DebutTestCoeur.html" class="click_box" href="#">
				...
				<figure>
					...
					<a href="\site\G4nalysis\Démarrer un ou plusieurs tests\DebutTestVisuel.html" class="click_box" href="#">
				...
				<figure>
					...
					<a href="\site\G4nalysis\Démarrer un ou plusieurs tests\DebutTestEtendueAuditive.html" class="click_box" href="#">
