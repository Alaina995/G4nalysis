...
<html>
    <head>
        <meta charset="utf-8" />
        <link rel="stylesheet" href="Nav_bar verticale.css" />
	...
	<?php require('../Nav_Bar_Website/nav_bar_principale.inc.html'); ?>
        ...
        <section class="features ">
                <figure>
                    ...
                    <p id="températe1">37°C</p>
                </figure>
                <figure>
                        <img src="images_projet/case_audit.png" alt="Tester audition">
                        <figcaption  id="audition">Audition</figcaption>
                        <p id="audition1">65% Précis</p>
                     </figure>
                     <figure>
                            <img src="images_projet/case_coeur.png" alt="Tester la fréquence de coeur">
                            <figcaption id="coeur">Coeur</figcaption>
                            <p  id="coeur1">75 Bpm</p>
                        </figure>
                        <figure>
                            <img src="images_projet/case_visu.png" alt="Tester la Visual">
                            <figcaption  id="visual">Visual</figcaption>
                            <p id="visual1">360ms</p>
                        </figure>
                        <figure>
                            <img src="images_projet/case_freq.png" alt="Tester la Entendu auditif">
                            <figcaption  id="étendu">Étendu auditif</figcaption>
                            <p id="étendu1">60%</p>
                        </figure>
        </section>
