...
<?php 
    ...
    if(empty($_POST['motdepasse'])){
        ...
        $_SESSION['motdepasse'] = "";
        setcookie('motdepasse',$_POST[''], time() + (90000 *30), "/");
    }
    ...
    if(empty($_POST['motdepasseConfirmation'])){
        ...
        setcookie('motdepasseConfirmation',$_POST[''], time() + (90000 *30), "/");
    }
    ...
    if(empty($_POST['Ville'])){
        ...
        $_SESSION['codepo'] = "";
        setcookie('codepo',$_POST[''], time() + (90000 *30), "/");
    }

    if(empty($_POST[''])){
        $_SESSION[''] ="Merci de remplir votre code postale";
    }
    ...
    if(empty($_POST['rue'])){
        ...
        $_SESSION['rue'] = "";
        setcookie('rue',$_POST[''], time() + (90000 *30), "/");
    }
    ...
    if(empty($_POST['nrue'])){
        ...
        $_SESSION['nrue'] = "";
        setcookie('nrue',$_POST[''], time() + (90000 *30), "/");
    }
