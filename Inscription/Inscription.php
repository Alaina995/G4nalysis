<html>
    ...
    <body>
        ...
        <nav>
            ...
            <a href="nous_contacter.html" class = "mdp" > Mon adresse n'apparait pas</a>
            ...
            <div class = "alignement">
                <a href="dashboard.hmtl" class = "connexion">S'inscrire</a> <!-- Page de connection compte -->
            </div>
